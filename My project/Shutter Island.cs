...
{
    public partial class Shutter_Island : Form
    {
        public Shutter_Island()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                Shutter_Island cc = new Shutter_Island();
        ...
        private void Shutter_Island_Load(object sender, EventArgs e)
        {
